...
const CartSwiperContainer = styled.div`
  ...
  .swiper-button-prev {
    background: url('https://kgy8987.github.io/goobne/images/Cart/arrow-left-short.svg')
      no-repeat;
  ...
  .swiper-button-next {
    background: url('https://kgy8987.github.io/goobne/images/Cart/arrow-right-short.svg')
      no-repeat;
    background-size: contain;
    position: absolute;
    width: 40px;
